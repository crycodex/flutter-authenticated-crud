...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == StockError.value) return 'El stock debe ser mayor a 0';
  ...
  StockError? validator(int value) {
    if (value == 0) return StockError.empty;
    if (value < 0) return StockError.value;
    if (int.tryParse(value.toString()) == -1) return StockError.value;
    return null;
  }
}
